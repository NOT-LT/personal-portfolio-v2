                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-start">
                    ...
                    <div className="reveal opacity-0 translate-y-4.5 transition-[opacity,transform] duration-550 [&.in]:opacity-100 [&.in]:translate-y-0 flex flex-col gap-10">
                        ...
                        <div className="mt-auto pt-2">
                            ...
                            >
                                <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24" className="transition-transform duration-200 group-hover:translate-y-0.5">
