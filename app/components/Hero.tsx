        ...
        <section className="min-h-screen flex items-center bg-bg pt-28.75 pb-16 sm:pb-25 relative overflow-hidden">
            ...
            <div className="max-w-275 mx-auto px-6 relative z-2 w-full sm:py-25 pointer-events-none">
                <div className="w-full xl:max-w-145 xl:pr-8 pointer-events-auto">
                    ...
                    <p className="animate-[fadeUp_0.5s_ease_both] [animation-delay:0.22s] font-display text-[clamp(1.3rem,2.4vw,2rem)] font-medium tracking-[-0.022em] leading-[1.3] text-muted mt-4 mb-7 max-w-130">
                        {tagline}<span className="text-accent">.</span>
                    </p>

                    <p className="font-text text-[0.9375rem] font-normal leading-[1.78] tracking-[-0.002em] text-muted animate-[fadeUp_0.5s_ease_both] [animation-delay:0.32s] max-w-122.5 mb-9">
                        {bioPart1}{' '}
                    ...
                    <div className="flex items-center gap-1.5 pb-3 flex-wrap">
                        <a href={ctaPrimary.href} className="inline-flex items-center gap-2 font-text text-sm font-medium tracking-[-0.008em] py-2.75 px-6 rounded-full cursor-pointer transition-[opacity,border-color] duration-180 whitespace-nowrap bg-accent border border-none text-bg hover:border-line-hover">
                            {ctaPrimary.label}
                            <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
                                <path d="M5 12h14M12 5l7 7-7 7" />
                            </svg>
                        </a>
                        <a href={ctaSecondary.href} className="inline-flex items-center gap-2 font-text text-sm font-medium tracking-[-0.008em] py-2.75 px-6 rounded-full cursor-pointer transition-[opacity,border-color] duration-180 whitespace-nowrap bg-transparent border border-faint text-fg hover:border-line-hover">{ctaSecondary.label}</a>
                    </div>
